...
namespace marcatel_api.Controllers
{
    ...
    public class CfgPuestosController : ControllerBase
    {
        private readonly CfgPuestosService _CfgPuestosService;

        public CfgPuestosController(CfgPuestosService cfgPuestos)
        {
            _CfgPuestosService = cfgPuestos;
        }
        ...
        [HttpPost("Insert")]
public JsonResult InsertCfgPuestos([FromBody] InsertCfgPuestosModel cfgPuestos)
{
    var objectResponse = Helper.GetStructResponse();
    try
    {
        var catClienteResponse = _CfgPuestosService.InsertCfgPuestos(cfgPuestos);
...
//}
        ...
        [HttpGet("Get")]
        public IActionResult GetCfgPuestos() 
        {
            var objectResponse = Helper.GetStructResponse();
            ResponsePuestos result = new ResponsePuestos();
            result.Response = new ResponseBodyCfgPuestos();
            result.Response.data = new List<GetCfgPuestosModel>();

            var CfgPuestosResponse = _CfgPuestosService.GetCfgPuestos();

            if (CfgPuestosResponse != null && CfgPuestosResponse.Any())
            {
                ...
                result.Response.data = CfgPuestosResponse;
                objectResponse.response = new
                {
        ...
        [HttpPut("Update")]
        public JsonResult UpdateCfgPuestosResponse([FromBody] UpdateCfgPuestosModel cfgPuestos)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                var CatClienteResponse = _CfgPuestosService.UpdateCfgPuestos(cfgPuestos);
        ...
        [HttpPut("Delete")]
public JsonResult DeleteCfgPuestos([FromBody] DeleteCfgPuestosModel cfgPuestos)
{
    var objectResponse = Helper.GetStructResponse();
    try
    {
        var catClienteResponse = _CfgPuestosService.DeleteCfgPuestos(cfgPuestos);
